...
with open('scrapyTest/drugs_info.json', 'r', encoding='utf-8') as drugs_file:
...
# print(drugs_file[0])
with open('drug_complete_data.json', 'w', encoding='utf-8') as file:
    file.write(json.dumps(drugs_file))
